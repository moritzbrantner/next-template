export const formsPage = {
  ...
  overview: {
    ...
    register:
      'Verbindet native Inputs mit dem Formular und haengt Regeln ohne zusaetzliche Wrapper an.',
    controller:
      'Bindet kontrollierte Komponenten an denselben Formularzustand an, wenn direkte Registrierung nicht moeglich ist.',
    reset:
      'Stellt Default-Werte wieder her, loescht Fehler und kann Teile des aktuellen Zustands behalten.',
  },
  interactions: {
    initialRender: {
      title: 'Initiales Rendern',
      required:
        'Regeln sind registriert, aber unberuehrte Felder zeigen meist noch keine Fehler.',
    ...
    validInput: {
      ...
      dirty:
        'Der Dirty-State wird true, weil sich der Wert vom Default unterscheidet.',
      validity:
        'Die Gueltigkeit wird true, sobald Validierung laeuft und keine weiteren Fehler mehr bestehen.',
      reset:
        '`reset()` stellt den Originalwert wieder her und loescht den Dirty-State.',
    },
    invalidClear: {
      title: 'Pflichtfeld wieder leeren',
      required: 'Das Feld verletzt erneut die Pflichtfeldregel.',
      dirty:
        'Das Feld bleibt dirty, bis es wieder exakt dem Default entspricht.',
    ...
    resetWithValues: {
      ...
      validity:
        'Die Gueltigkeit wird aus dem neuen Reset-Zustand neu berechnet.',
