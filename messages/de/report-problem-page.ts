export const reportProblemPage = {
  ...
  checklistDescription: 'Ein paar konkrete Angaben sparen meistens mehrere Rückfragen.',
  checklist: {
    summary: {
      title: 'Beginne mit dem Symptom',
      description: 'Beschreibe zuerst den sichtbaren Fehler, damit das Problem sofort eingeordnet werden kann.',
    },
    context: {
      title: 'Nenne die betroffene Stelle',
      description: 'Gib die Seite, den Ablauf oder die Aktion an und erwähne, ob der Fehler jedes Mal auftritt.',
    },
    contact: {
      title: 'Hinterlasse einen erreichbaren Kontakt',
      description: 'Nutze eine E-Mail-Adresse, unter der Rückfragen zu Screenshots, Zeitpunkten oder Repro-Schritten möglich sind.',
    },
  },
  ...
  privacyNote: 'Bitte keine Passwörter, Geheimnisse oder unnötigen personenbezogenen Daten einfügen.',
  fields: {
    name: {
      label: 'Dein Name',
    ...
    details: {
      ...
      placeholder: 'Was hast du erwartet, was ist tatsächlich passiert und wie lässt sich das Problem reproduzieren?',
    },
  },
  footnote: 'Die Pflichtfelder reichen zum Melden. Zusätzlicher Kontext beschleunigt nur die Einordnung.',
  actions: {
  ...
  errors: {
    generic: 'Der Bericht konnte nicht gesendet werden. Bitte prüfe das Formular und versuche es erneut.',
  },
};
