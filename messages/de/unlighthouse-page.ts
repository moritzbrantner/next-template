export const unlighthousePage = {
  ...
  description:
    'Diese Seite fasst die neueste `ci-result.json` aus dem GitHub-Pages-Build zusammen.',
  emptyTitle: 'Noch kein Bericht vorhanden',
  emptyDescription:
    'Fuehre `bun run build:gh-pages` aus oder starte den GitHub-Pages-Workflow, um `.generated/unlighthouse/ci-result.json` zu erzeugen.',
  summary: {
