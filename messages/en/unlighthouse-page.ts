export const unlighthousePage = {
  ...
  description:
    'This page summarizes the latest `ci-result.json` baked into the GitHub Pages build.',
  emptyTitle: 'No report available yet',
  emptyDescription:
    'Run `bun run build:gh-pages` or the GitHub Pages workflow to generate `.generated/unlighthouse/ci-result.json`.',
  summary: {
