...
export function resolveOAuthPageError(searchParams: Record<string, string | string[] | undefined> | undefined): {
  ...
  if (!provider || !error || !isAuthProvider(provider) || !isOAuthErrorCode(error)) {
    return null;
  }
