...
import { appPageDefinitions, getVisibleAppPages } from '@/src/navigation/app-routes';
...
describe('app routes', () => {
  ...
  ])('exposes the right hotkey destinations for $label', ({ input, visibleKeys, hiddenKeys }) => {
