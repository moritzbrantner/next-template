  ...
  it.each([
    {
      ...
      hiddenKeys: ['people', 'messages', 'notifications', 'dataEntry', 'profile', 'settings', 'admin'],
    },
    {
      label: 'signed-in users',
      input: { isAuthenticated: true, role: 'USER' as const },
      visibleKeys: ['home', 'people', 'messages', 'notifications', 'dataEntry', 'profile', 'settings'],
    ...
    },
    {
      ...
      visibleKeys: ['people', 'messages', 'notifications', 'dataEntry', 'profile', 'settings', 'admin'],
